...
# We need request sockets of waitress to produce "broken-stream" and "return-reset-connection"
# error. If we are going to update waitress vesion in setup.py then code in this file may also needs to be updated.
